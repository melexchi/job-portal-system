...
import com.melex.job.mapper.JobMapper;
...
import com.melex.job.repository.JobRepository;
import com.melex.job.repository.JobSpecification;
...
//        job.setTags(tags);
        ...
        job.setExpiresAt(req.getExpiredAt());
